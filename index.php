        ...
        <div class="navbar-header">
          ...
          <li>
           <a href="index.php?s=home">Inicio</a>
            ...
            <li>
            <a href="index.php?s=shop">Tienda</a>
            </li>
            <li>
            <a href="index.php?s=ranking">Ranking</a>
            </li>
            <li>
            <a href="index.php?s=cargar">Donaciones</a>
            </li>
            <li>
             <a href="#">Foro</a>
            </li>          
    	 ...
    	 <div class="row">
          <div class="col-lg-4">
            <div class="bs-component">
			 ...
			 <?php if($_SESSION['login'] && $_GET['s'] != 'shop') { ?>
			...
			<div class="widget-fluid userInfo clearfix">
				  ...
				  <ul class="menuList">
				     ...
				     <li><a href="index.php?s=msg"><span class="glyphicon glyphicon-comment"></span> Mensajes</a> <span class="badge" style="font-size:8px;"><?php echo $class->msg_read($_SESSION['id']); ?></span></li>
				...
				<?php  } else if($_SESSION['login'] && $_GET['s'] == 'shop') { ?>
			  <?php include("pages/cats.php"); ?>
			<?php } else { ?>
			...
			<input placeholder="Contraseña"  type="password" name="contrasena" id="contrasena" class="form-control input-sm" type="text" required>
				  ...
				  <div style="margin-top:10px;"><a class="menuLost" href="index.php?s=lostpass">Ha olvidado su contraseña?</a></div>
				</form>
				<?php } ?>
				  </div>
				</div>
				 <div class="panel panel-danger" id="registrate">
				  <div class="panel-heading">
				...
				<div class="panel panel-danger" id="descargacliente">
				  <div class="panel-heading">
				 ...
				 <div class="panel panel-danger" id="trailer">
				  <div class="panel-heading">
				    <h3 class="panel-title">Trailer</h3>
				    </div>
				    <div class="panel-body">
				    <iframe class="img-responsive" width="280" height="200" src="https://www.youtube.com/embed/FMm7UiS8mU4" frameborder="0" allowfullscreen></iframe>
				  </div>
				</div>
                </div>
          	    </div>
          	    <?php
					...
					$pid = addslashes(htmlentities($_GET["pid"]));
